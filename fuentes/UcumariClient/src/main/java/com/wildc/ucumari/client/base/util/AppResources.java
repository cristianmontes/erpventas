...
public class AppResources {
    ...
    private static AppResources appBundle = null;
    ...
    private AppResources(){        
        ...
        try{
            InputStream is = AppResources.class.getResourceAsStream(Constantes.FILE_APP_RESOURCES);
            mapresource.load(is);
            is.close();
        }catch(IOException e){
