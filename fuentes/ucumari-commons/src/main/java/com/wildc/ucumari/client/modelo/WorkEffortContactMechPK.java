...
public class WorkEffortContactMechPK implements Serializable {
    ...
    public WorkEffortContactMechPK() {
    }

    public WorkEffortContactMechPK(String workEffortId, String contactMechId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WorkEffortContactMechPK)) {
            return false;
        }
        WorkEffortContactMechPK other = (WorkEffortContactMechPK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.WorkEffortContactMechPK[ workEffortId=" + workEffortId + ", contactMechId=" + contactMechId + " ]";
    }
