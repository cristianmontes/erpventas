...
public class RequirementRolePK implements Serializable {
    ...
    public RequirementRolePK(String requirementId, String partyId, String roleTypeId, Date fromDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RequirementRolePK)) {
            return false;
        }
        RequirementRolePK other = (RequirementRolePK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.RequirementRolePK[ requirementId=" + requirementId + ", partyId=" + partyId + ", roleTypeId=" + roleTypeId + ", fromDate=" + fromDate + " ]";
    }
