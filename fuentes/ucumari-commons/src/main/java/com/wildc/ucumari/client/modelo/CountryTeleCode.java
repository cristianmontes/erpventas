...
@NamedQueries({
    @NamedQuery(name = "CountryTeleCode.findAll", query = "SELECT c FROM CountryTeleCode c")})
public class CountryTeleCode implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CountryTeleCode)) {
            return false;
        }
        CountryTeleCode other = (CountryTeleCode) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.CountryTeleCode[ countryCode=" + countryCode + " ]";
    }
