...
public class CreditCard implements Serializable {
    ...
    private BigInteger consecutiveFailedAuths;
    @Column(name = "LAST_FAILED_AUTH_DATE")
    @Temporal(TemporalType.TIMESTAMP)
    private Date lastFailedAuthDate;
    @Column(name = "CONSECUTIVE_FAILED_NSF")
    private BigInteger consecutiveFailedNsf;
    @Column(name = "LAST_FAILED_NSF_DATE")
    @Temporal(TemporalType.TIMESTAMP)
    private Date lastFailedNsfDate;
    ...
    public BigInteger getConsecutiveFailedAuths() {
        return consecutiveFailedAuths;
    }

    public void setConsecutiveFailedAuths(BigInteger consecutiveFailedAuths) {
    ...
    public void setLastFailedAuthDate(Date lastFailedAuthDate) {
        this.lastFailedAuthDate = lastFailedAuthDate;
    }

    public BigInteger getConsecutiveFailedNsf() {
        return consecutiveFailedNsf;
    }

    public void setConsecutiveFailedNsf(BigInteger consecutiveFailedNsf) {
    ...
    public void setLastFailedNsfDate(Date lastFailedNsfDate) {
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.CreditCard[ paymentMethodId=" + paymentMethodId + " ]";
    }
