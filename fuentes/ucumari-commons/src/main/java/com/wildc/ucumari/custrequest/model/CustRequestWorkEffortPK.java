...
public class CustRequestWorkEffortPK implements Serializable {
    ...
    public CustRequestWorkEffortPK(String custRequestId, String workEffortId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CustRequestWorkEffortPK)) {
            return false;
        }
        CustRequestWorkEffortPK other = (CustRequestWorkEffortPK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.CustRequestWorkEffortPK[ custRequestId=" + custRequestId + ", workEffortId=" + workEffortId + " ]";
    }
