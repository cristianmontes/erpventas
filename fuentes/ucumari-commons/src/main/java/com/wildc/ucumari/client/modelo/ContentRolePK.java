...
public class ContentRolePK implements Serializable {
    ...
    public ContentRolePK() {
    }

    public ContentRolePK(String contentId, String partyId, String roleTypeId, Date fromDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ContentRolePK)) {
            return false;
        }
        ContentRolePK other = (ContentRolePK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.ContentRolePK[ contentId=" + contentId + ", partyId=" + partyId + ", roleTypeId=" + roleTypeId + ", fromDate=" + fromDate + " ]";
    }
