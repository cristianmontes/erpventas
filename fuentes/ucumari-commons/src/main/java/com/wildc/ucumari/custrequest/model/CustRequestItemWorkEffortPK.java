...
public class CustRequestItemWorkEffortPK implements Serializable {
    ...
    public CustRequestItemWorkEffortPK(String custRequestId, String custRequestItemSeqId, String workEffortId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CustRequestItemWorkEffortPK)) {
            return false;
        }
        CustRequestItemWorkEffortPK other = (CustRequestItemWorkEffortPK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.CustRequestItemWorkEffortPK[ custRequestId=" + custRequestId + ", custRequestItemSeqId=" + custRequestItemSeqId + ", workEffortId=" + workEffortId + " ]";
    }
