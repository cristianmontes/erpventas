...
public class ContainerType implements Serializable {
    ...
    /*@OneToMany(mappedBy = "containerTypeId")
    private List<Container> containerList;*/

    public ContainerType() {
    }

    public ContainerType(String containerTypeId) {
...
/*
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.ContainerType[ containerTypeId=" + containerTypeId + " ]";
    }
