...
@NamedQueries({
    @NamedQuery(name = "PartyIcsAvsOverride.findAll", query = "SELECT p FROM PartyIcsAvsOverride p")})
public class PartyIcsAvsOverride implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PartyIcsAvsOverride)) {
            return false;
        }
        PartyIcsAvsOverride other = (PartyIcsAvsOverride) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.PartyIcsAvsOverride[ partyId=" + partyId + " ]";
    }
