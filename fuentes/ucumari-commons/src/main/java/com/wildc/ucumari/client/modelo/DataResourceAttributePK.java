...
public class DataResourceAttributePK implements Serializable {
    ...
    public DataResourceAttributePK() {
    }

    public DataResourceAttributePK(String dataResourceId, String attrName) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof DataResourceAttributePK)) {
            return false;
        }
        DataResourceAttributePK other = (DataResourceAttributePK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.DataResourceAttributePK[ dataResourceId=" + dataResourceId + ", attrName=" + attrName + " ]";
    }
