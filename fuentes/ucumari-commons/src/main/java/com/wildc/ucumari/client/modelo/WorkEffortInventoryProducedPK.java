...
public class WorkEffortInventoryProducedPK implements Serializable {
    ...
    public WorkEffortInventoryProducedPK() {
    }

    public WorkEffortInventoryProducedPK(String workEffortId, String inventoryItemId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof WorkEffortInventoryProducedPK)) {
            return false;
        }
        WorkEffortInventoryProducedPK other = (WorkEffortInventoryProducedPK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.WorkEffortInventoryProducedPK[ workEffortId=" + workEffortId + ", inventoryItemId=" + inventoryItemId + " ]";
    }
