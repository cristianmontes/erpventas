...
@NamedQueries({
    @NamedQuery(name = "ValueLinkFulfillment.findAll", query = "SELECT v FROM ValueLinkFulfillment v")})
public class ValueLinkFulfillment implements Serializable {
    ...
    public ValueLinkFulfillment() {
    }

    public ValueLinkFulfillment(String fulfillmentId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ValueLinkFulfillment)) {
            return false;
        }
        ValueLinkFulfillment other = (ValueLinkFulfillment) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.ValueLinkFulfillment[ fulfillmentId=" + fulfillmentId + " ]";
    }
