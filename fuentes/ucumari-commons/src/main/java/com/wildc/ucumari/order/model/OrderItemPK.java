...
public class OrderItemPK implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 8158200972228755887L;
    ...
    public OrderItemPK(String orderId, String orderItemSeqId) {
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.OrderItemPK[ orderId=" + orderId + ", orderItemSeqId=" + orderItemSeqId + " ]";
    }
