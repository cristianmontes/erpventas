...
public class PersonTrainingPK implements Serializable {
    ...
    public PersonTrainingPK() {
    }

    public PersonTrainingPK(String partyId, String trainingClassTypeId, Date fromDate) {
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.PersonTrainingPK[ partyId=" + partyId + ", trainingClassTypeId=" + trainingClassTypeId + ", fromDate=" + fromDate + " ]";
    }
