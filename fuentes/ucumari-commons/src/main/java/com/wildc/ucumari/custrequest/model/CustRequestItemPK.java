...
public class CustRequestItemPK implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3884924537195541530L;
    ...
    public CustRequestItemPK(String custRequestId, String custRequestItemSeqId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CustRequestItemPK)) {
            return false;
        }
        CustRequestItemPK other = (CustRequestItemPK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.CustRequestItemPK[ custRequestId=" + custRequestId + ", custRequestItemSeqId=" + custRequestItemSeqId + " ]";
    }
