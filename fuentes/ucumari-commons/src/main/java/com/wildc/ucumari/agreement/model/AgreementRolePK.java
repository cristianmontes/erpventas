...
public class AgreementRolePK implements Serializable {
    ...
    public AgreementRolePK() {
    }

    public AgreementRolePK(String agreementId, String partyId, String roleTypeId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AgreementRolePK)) {
            return false;
        }
        AgreementRolePK other = (AgreementRolePK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.AgreementRolePK[ agreementId=" + agreementId + ", partyId=" + partyId + ", roleTypeId=" + roleTypeId + " ]";
    }
