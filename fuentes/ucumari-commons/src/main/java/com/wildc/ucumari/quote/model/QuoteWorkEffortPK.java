...
public class QuoteWorkEffortPK implements Serializable {
    ...
    public QuoteWorkEffortPK(String quoteId, String workEffortId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof QuoteWorkEffortPK)) {
            return false;
        }
        QuoteWorkEffortPK other = (QuoteWorkEffortPK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.QuoteWorkEffortPK[ quoteId=" + quoteId + ", workEffortId=" + workEffortId + " ]";
    }
