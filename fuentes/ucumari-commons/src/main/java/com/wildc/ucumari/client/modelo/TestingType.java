...
@NamedQueries({
    @NamedQuery(name = "TestingType.findAll", query = "SELECT t FROM TestingType t")})
public class TestingType implements Serializable {
    ...
    @OneToMany(mappedBy = "testingTypeId")
    ...
    public int hashCode() {
        int hash = 0;
        hash += (testingTypeId != null ? testingTypeId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TestingType)) {
            return false;
        }
        TestingType other = (TestingType) object;
        if ((this.testingTypeId == null && other.testingTypeId != null) || (this.testingTypeId != null && !this.testingTypeId.equals(other.testingTypeId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.TestingType[ testingTypeId=" + testingTypeId + " ]";
    }
