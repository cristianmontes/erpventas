...
public class FacilityRolePK implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1017861244409999270L;
    ...
    public FacilityRolePK() {
    }

    public FacilityRolePK(String facilityId, String partyId, String roleTypeId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FacilityRolePK)) {
            return false;
        }
        FacilityRolePK other = (FacilityRolePK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.FacilityRolePK[ facilityId=" + facilityId + ", partyId=" + partyId + ", roleTypeId=" + roleTypeId + " ]";
    }
