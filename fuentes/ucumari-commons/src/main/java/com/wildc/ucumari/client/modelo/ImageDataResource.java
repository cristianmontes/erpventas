...
@NamedQueries({
    @NamedQuery(name = "ImageDataResource.findAll", query = "SELECT i FROM ImageDataResource i")})
public class ImageDataResource implements Serializable {
    ...
    public ImageDataResource(String dataResourceId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ImageDataResource)) {
            return false;
        }
        ImageDataResource other = (ImageDataResource) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.ImageDataResource[ dataResourceId=" + dataResourceId + " ]";
    }
