...
public class PartyRolePK implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 4938897440719742813L;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PartyRolePK)) {
            return false;
        }
        PartyRolePK other = (PartyRolePK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.PartyRolePK[ partyId=" + partyId + ", roleTypeId=" + roleTypeId + " ]";
    }
