...
public class UomConversion implements Serializable {
    ...
    @EmbeddedId
    protected UomConversionPK uomConversionPK;
    ...
    public UomConversion(UomConversionPK uomConversionPK) {
        this.uomConversionPK = uomConversionPK;
    }

    public UomConversion(String uomId, String uomIdTo) {
        this.uomConversionPK = new UomConversionPK(uomId, uomIdTo);
    }

    public UomConversionPK getUomConversionPK() {
        return uomConversionPK;
    }

    public void setUomConversionPK(UomConversionPK uomConversionPK) {
        this.uomConversionPK = uomConversionPK;
    }
    ...
    public int hashCode() {
        int hash = 0;
        hash += (uomConversionPK != null ? uomConversionPK.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if ((this.uomConversionPK == null && other.uomConversionPK != null) || (this.uomConversionPK != null && !this.uomConversionPK.equals(other.uomConversionPK))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.UomConversion[ uomConversionPK=" + uomConversionPK + " ]";
    }
