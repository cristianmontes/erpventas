...
@NamedQueries({
    @NamedQuery(name = "OtherDataResource.findAll", query = "SELECT o FROM OtherDataResource o")})
public class OtherDataResource implements Serializable {
    ...
    public OtherDataResource(String dataResourceId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof OtherDataResource)) {
            return false;
        }
        OtherDataResource other = (OtherDataResource) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.OtherDataResource[ dataResourceId=" + dataResourceId + " ]";
    }
