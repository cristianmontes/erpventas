...
public class ProductPromoProductPK implements Serializable {
    ...
    public ProductPromoProductPK() {
    }

    public ProductPromoProductPK(String productPromoId, String productPromoRuleId, String productPromoActionSeqId, String productPromoCondSeqId, String productId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProductPromoProductPK)) {
            return false;
        }
        ProductPromoProductPK other = (ProductPromoProductPK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.ProductPromoProductPK[ productPromoId=" + productPromoId + ", productPromoRuleId=" + productPromoRuleId + ", productPromoActionSeqId=" + productPromoActionSeqId + ", productPromoCondSeqId=" + productPromoCondSeqId + ", productId=" + productId + " ]";
    }
