...
public class ProdCatalogRolePK implements Serializable {
    ...
    public ProdCatalogRolePK() {
    }

    public ProdCatalogRolePK(String partyId, String roleTypeId, String prodCatalogId, Date fromDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ProdCatalogRolePK)) {
            return false;
        }
        ProdCatalogRolePK other = (ProdCatalogRolePK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.ProdCatalogRolePK[ partyId=" + partyId + ", roleTypeId=" + roleTypeId + ", prodCatalogId=" + prodCatalogId + ", fromDate=" + fromDate + " ]";
    }
