...
public class EmploymentPK implements Serializable {
    ...
    public EmploymentPK(String roleTypeIdFrom, String roleTypeIdTo, String partyIdFrom, String partyIdTo, Date fromDate) {
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.EmploymentPK[ roleTypeIdFrom=" + roleTypeIdFrom + ", roleTypeIdTo=" + roleTypeIdTo + ", partyIdFrom=" + partyIdFrom + ", partyIdTo=" + partyIdTo + ", fromDate=" + fromDate + " ]";
    }
