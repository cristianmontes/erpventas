...
public class ReturnReason implements Serializable {
    ...
    @OneToMany(mappedBy = "returnReasonId")
    private List<ReturnItem> returnItemList;

    public ReturnReason() {
    }

    public ReturnReason(String returnReasonId) {
    ...
    public int hashCode() {
        int hash = 0;
        hash += (returnReasonId != null ? returnReasonId.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof ReturnReason)) {
            return false;
        }
        ReturnReason other = (ReturnReason) object;
        if ((this.returnReasonId == null && other.returnReasonId != null) || (this.returnReasonId != null && !this.returnReasonId.equals(other.returnReasonId))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.ReturnReason[ returnReasonId=" + returnReasonId + " ]";
    }
