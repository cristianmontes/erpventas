...
public class PartyContentPK implements Serializable {
    ...
    public PartyContentPK() {
    }

    public PartyContentPK(String partyId, String contentId, String partyContentTypeId, Date fromDate) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof PartyContentPK)) {
            return false;
        }
        PartyContentPK other = (PartyContentPK) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.PartyContentPK[ partyId=" + partyId + ", contentId=" + contentId + ", partyContentTypeId=" + partyContentTypeId + ", fromDate=" + fromDate + " ]";
    }
