...
@NamedQueries({
    @NamedQuery(name = "VideoDataResource.findAll", query = "SELECT v FROM VideoDataResource v")})
public class VideoDataResource implements Serializable {
    ...
    public VideoDataResource(String dataResourceId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof VideoDataResource)) {
            return false;
        }
        VideoDataResource other = (VideoDataResource) object;
    ...
    public String toString() {
        return "com.wildc.ucumari.client.modelo.VideoDataResource[ dataResourceId=" + dataResourceId + " ]";
    }
